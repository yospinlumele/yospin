...
Jadwal kontrol 
  ...
  <div class="row"> 
  <div class="col"> 
  <p class="text-black mt-5"><b>Selamat Datang di Daftar Rekam Medis dr.Ely Yuris Sp.N M.Kes</b></p> 
  </div> 
  </div> 
<div class="container-fluid my-12">
  <div class="row">
    <div class="col-md-12"> 
      <div class="card">
        <div class="card-header text-center"><b>dr.ELY YURIS Sp.N M.Kes</b></div>
        <div class="card-body">
         <table border 
