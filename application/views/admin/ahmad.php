...
Jadwal kontrol 
  ...
  <div class="row"> 
  <div class="col"> 
  <p class="text-black mt-5"><b>Selamat Datang di Daftar Rekam Medis dr.Ahmad Mudassir,Sp.Pd</b></p> 
  </div> 
  </div> 
<div class="container-fluid my-12">
  <div class="row">
    <div class="col-md-12"> 
      <div class="card">
        <div class="card-header text-center"><b>dr.AHMAD MUDASSIR,Sp.Pd</b></div>
        <div class="card-body">
         <table border 
