...
Jadwal kontrol 
  ...
  <div class="row"> 
  <div class="col"> 
  <p class="text-black mt-5"><b>Selamat Datang di Daftar Rekam Medis dr.Prarindra Khrisanti Toriki,Sp.A</b></p> 
  </div> 
  </div> 
<div class="container-fluid my-12">
  <div class="row">
    <div class="col-md-12"> 
      <div class="card">
        <div class="card-header text-center"><b>dr.PRARINDRA KHRISANTI TORIKI,Sp.A</b></div>
        <div class="card-body">
         <table border 
