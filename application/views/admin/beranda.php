    <div class="container">
      <div class="row">
        <div class="col">
            <p class="text-white mt-5">Selamat Datang, <b><?= $user['nama']; ?></b></p>
        </div>
      </div>
      <!-- row -->
      <div class="row justify-content-center">
        <div class="col-4">
          ...
          <div class="row justify-content-center">
            <div class="col-4">
              <a href="<?= base_url(); ?>admin/antrian/info_antrian" target="blank" class="btn btn-info"><b>Tampilkan</b></a>
            </div>
          </div>
          <?php endforeach ?>
        </div>
      ...
      <div class="row tm-content-row mt-3">
        <div class="col-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
            <div class="row">
              <div class="col-6">
                <h2 class="tm-block-title">Daftar Antrian</h2>
              </div>
              <div class="col-6">
